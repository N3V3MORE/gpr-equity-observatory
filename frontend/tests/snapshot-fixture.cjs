...
function validSnapshot(extraDatasets = []) {
  const headline = { country_count: 1, shock_count: 0, start_date: "2024-01-01", end_date: "2024-01-03" };
  ...
  return {
    ...
    overview: { headline },
    gpr_timeline: { series: [{ date: "2024-01-01", gpr: 0 }, { date: "2024-01-02", gpr: null }, { date: "2024-01-03", gpr: 1 }], top_shocks: [] },
    ...
    event_study: ["developed", "emerging"].flatMap((market_group) => [
      { market_group, relative_day: 0, cumulative_average_abnormal_return: 0, cumulative_average_return: 0 },
      { market_group, relative_day: 1, cumulative_average_abnormal_return: null, cumulative_average_return: null },
    ]),
    regression: {
    ...
    reader_summaries: {
      ...
      market_reaction: [{ market_group: "Developed markets", relative_day: 0, cumulative_average_abnormal_return: 0, direction: "Uncertain", evidence_strength: "Test", plain_note: "Synthetic" }],
